...
const stingapi = async function get() {
  ...
  document.querySelector("#TableAutoSting2 img").src = media[2].guid.rendered;
  ...
  document.querySelector("#TableAutoSting3 img").src = media[3].guid.rendered;
  ...
  document.querySelector("#TableAutoSting4 img").src = media[4].guid.rendered;
  ...
  document.querySelector("#TableAutoSting5 img").src = media[5].guid.rendered;
  ...
  document.querySelector("#TableAutoSting6 img").src = media[6].guid.rendered;
  ...
  document.querySelector("#TableAutoSting7 img").src = media[7].guid.rendered;
  ...
  document.querySelector("#TableAutoSting8 img").src = media[8].guid.rendered;
